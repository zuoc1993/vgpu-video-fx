...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu/packages/effect-core/src/effects/pixeliz0r/effect.wgsl
struct _vgsl_23476bfa__Params {
  bw: f32,
  bh: f32,
  resolution: vec2f,
  videoSize: vec2f,
...
@group(0) @binding(2) var<uniform> params: _vgsl_23476bfa__Params;
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  return _vgsl_35d1d59a__sampleVideo(src, samp, center);
}
