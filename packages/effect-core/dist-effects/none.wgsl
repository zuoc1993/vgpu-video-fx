...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu/packages/effect-core/src/effects/none/effect.wgsl
struct _vgsl_86e3a2d7__Params {
  time: f32,
  resolution: vec2f,
  videoSize: vec2f,
}
...
@group(0) @binding(2) var<uniform> params: _vgsl_86e3a2d7__Params;

@fragment
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  return _vgsl_35d1d59a__sampleVideo(src, samp, _vgsl_35d1d59a__containUv(uv, params.resolution, params.videoSize));
}
