...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu-video-fx/packages/effect-core/src/effects/none/effect.wgsl
struct _vgsl_12ab3f63__Params {
  time: f32,
  resolution: vec2f,
  videoSize: vec2f,
}
...
@group(0) @binding(2) var<uniform> params: _vgsl_12ab3f63__Params;

@fragment
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  return _vgsl_17688d6e__sampleVideo(src, samp, _vgsl_17688d6e__containUv(uv, params.resolution, params.videoSize));
}
