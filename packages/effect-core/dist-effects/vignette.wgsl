...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu/packages/effect-core/src/effects/vignette/effect.wgsl
struct _vgsl_548d4bd6__Params {
  amount: f32,
  radius: f32,
  softness: f32,
  resolution: vec2f,
...
@group(0) @binding(2) var<uniform> params: _vgsl_548d4bd6__Params;
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  return vec4f(_vgsl_35d1d59a__sampleVideo(src, samp, v).rgb * dim, 1.0);
}
