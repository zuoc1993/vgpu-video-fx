...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu-video-fx/packages/effect-core/src/effects/vignette/effect.wgsl
struct _vgsl_418c36b6__Params {
  amount: f32,
  radius: f32,
  softness: f32,
  resolution: vec2f,
...
@group(0) @binding(2) var<uniform> params: _vgsl_418c36b6__Params;
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  return vec4f(_vgsl_17688d6e__sampleVideo(src, samp, v).rgb * dim, 1.0);
}
