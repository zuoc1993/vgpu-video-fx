...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu/packages/effect-core/src/effects/dither/effect.wgsl
struct _vgsl_308d6bcd__Params {
  levels: f32,
  resolution: vec2f,
  videoSize: vec2f,
}
...
@group(0) @binding(2) var<uniform> params: _vgsl_308d6bcd__Params;
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  let d = _vgsl_95d6fc5a__bayer4(coords) - 0.5;
  var col = _vgsl_35d1d59a__sampleVideo(src, samp, v).rgb * bands;
