...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu-video-fx/packages/effect-core/src/effects/dither/effect.wgsl
struct _vgsl_78bd44f3__Params {
  levels: f32,
  resolution: vec2f,
  videoSize: vec2f,
}
...
@group(0) @binding(2) var<uniform> params: _vgsl_78bd44f3__Params;
