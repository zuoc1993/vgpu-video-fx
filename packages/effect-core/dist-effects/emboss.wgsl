...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu-video-fx/packages/effect-core/src/effects/emboss/effect.wgsl
struct _vgsl_eb75bc05__Params {
  azimuth: f32,
  elevation: f32,
  width: f32,
  resolution: vec2f,
...
@group(0) @binding(2) var<uniform> params: _vgsl_eb75bc05__Params;
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  let h0 = _vgsl_8e3019cf__lumOf(_vgsl_17688d6e__sampleVideoClamp(src, samp, v).rgb);
  let h1 = _vgsl_8e3019cf__lumOf(_vgsl_17688d6e__sampleVideoClamp(src, samp, v + off).rgb);
