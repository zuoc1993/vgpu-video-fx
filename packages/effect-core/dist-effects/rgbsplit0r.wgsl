...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu/packages/effect-core/src/effects/rgbsplit0r/effect.wgsl
struct _vgsl_88d1fdd0__Params {
  vertical: f32,
  horizontal: f32,
  resolution: vec2f,
  videoSize: vec2f,
...
@group(0) @binding(2) var<uniform> params: _vgsl_88d1fdd0__Params;

fn _vgsl_88d1fdd0__channel(uv: vec2f, axis: f32) -> vec3f {
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  let r = _vgsl_88d1fdd0__channel(v, params.horizontal).r;
  let b = _vgsl_88d1fdd0__channel(v, params.vertical).b;
  let g = _vgsl_88d1fdd0__channel(v, 0.5).g;
