...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu-video-fx/packages/effect-core/src/effects/kaleid0sc0pe/effect.wgsl
struct _vgsl_d84d46a7__Params {
  time: f32,
  segs: f32,
  zoom: f32,
  speed: f32,
...
@group(0) @binding(2) var<uniform> params: _vgsl_d84d46a7__Params;
