...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu/packages/effect-core/src/effects/posterize/effect.wgsl
struct _vgsl_27dbbc15__Params {
  levels: f32,
  resolution: vec2f,
  videoSize: vec2f,
}
...
@group(0) @binding(2) var<uniform> params: _vgsl_27dbbc15__Params;
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  let inv = 1.0 / bands;
  let col = floor(_vgsl_35d1d59a__sampleVideo(src, samp, v).rgb * bands + 0.5) * inv;
