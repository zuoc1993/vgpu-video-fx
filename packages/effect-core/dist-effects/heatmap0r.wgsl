...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu-video-fx/packages/effect-core/src/effects/heatmap0r/effect.wgsl
struct _vgsl_79c84049__Params {
  hueShift: f32,
  greyPoint: f32,
  resolution: vec2f,
  videoSize: vec2f,
...
@group(0) @binding(2) var<uniform> params: _vgsl_79c84049__Params;
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  let l = _vgsl_8e3019cf__lumOf(_vgsl_17688d6e__sampleVideo(src, samp, v).rgb);
  ...
  col = _vgsl_8e3019cf__hueRotate(col, params.hueShift);
