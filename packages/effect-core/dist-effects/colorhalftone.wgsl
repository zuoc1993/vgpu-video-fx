...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  let dotC = _vgsl_8e3019cf__halftoneDot(p, params.angC * 3.14159, freq, 1.0 - ink.r);
  let dotM = _vgsl_8e3019cf__halftoneDot(p, params.angM * 3.14159 + 1.257, freq, 1.0 - ink.g);
  let dotY = _vgsl_8e3019cf__halftoneDot(p, params.angY * 3.14159 + 2.513, freq, 1.0 - ink.b);
  let paper = vec3f(1.0);
