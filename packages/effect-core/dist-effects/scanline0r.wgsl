...
// vgsl-module: /Users/zuoc/Documents/vscode/vgpu/packages/effect-core/src/effects/scanline0r/effect.wgsl
struct _vgsl_fe4b16b9__Params {
  strength: f32,
  resolution: vec2f,
  videoSize: vec2f,
}
...
@group(0) @binding(2) var<uniform> params: _vgsl_fe4b16b9__Params;

fn _vgsl_fe4b16b9__sampleAt(uv: vec2f) -> vec3f {
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  var col = _vgsl_fe4b16b9__sampleAt(v);
  // CRT aperture grille on line rows: R/B read half a pixel off.
  col.r = mix(col.r, _vgsl_fe4b16b9__sampleAt(v + vec2f(half, 0.0)).r, line);
  col.b = mix(col.b, _vgsl_fe4b16b9__sampleAt(v - vec2f(half, 0.0)).b, line);
