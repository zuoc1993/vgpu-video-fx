...
export const cylinderWrapEffect: EffectDefinition = {
  ...
  params: [
    ...
    { key: "dir", label: "旋转方向", type: "range", min: -1, max: 1, step: 1, default: 1 },
    { key: "inner", label: "内壁视角", type: "range", min: 0, max: 1, step: 1, default: 0 },
    { key: "innerScale", label: "内壁缩放", type: "range", min: 0.5, max: 1.2, step: 0.01, default: 0.72 },
