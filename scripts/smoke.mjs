...
const cases = {
  none: {},
  "camera-shake": { intensity: 0.5, speed: 1, frequency: 12, rotation: 0.25, zoom: 0.15 },
  ...
  "zoom-in": { startScale: 1.0, endScale: 1.35, duration: 1, looping: 0, centerX: 0.5, centerY: 0.5, drift: 0 },
  "zoom-out": { startScale: 1.35, endScale: 1.0, duration: 1, looping: 0, centerX: 0.5, centerY: 0.5, drift: 0.35 },
  ...
  defish0r: { amount: 0.55, scale: 0.9, mode: 1 },
  ...
  pixs0r: { intensity: 0.5, blockHeight: 12, columns: 0.35, speed: 0.6 },
  dither: { levels: 0.05 },
  ...
  dissolve: { speed: 0.5, scale: 5, edgeGlow: 0.8, invert: 1 },
